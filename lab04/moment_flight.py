...
if __name__ == '__main__':
    ...
    drone_client.move(0.0, 0.0, 0.5, 7.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -3.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -6.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, 1.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, 5.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, 3.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -2.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -6.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -11.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -7.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -4.0, 3.0)
    drone_client.move(0.0, 0.0, 0.5, -2.0, 3.0)
