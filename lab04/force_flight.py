...
uri = 'radio://0/13/2M/E7E7E7E7E7' # <-- FIXME
...
if __name__ == '__main__':
    ...
    drone_client.move(0.0, 0.0, 0.42, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.51, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.39, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.46, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.57, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.45, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.56, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.63, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.53, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.47, 0.0, 3.0)
    drone_client.move(0.0, 0.0, 0.55, 0.0, 3.0)    
